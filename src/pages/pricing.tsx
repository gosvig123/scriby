    ...
    <div className="w-screen h-screen overflow-hidden">
      ...
      <div className="flex w-full h-3/4 px-5 ">
        <div className="w-3/5 h-3/4 text-center  flex-auto justify-around items-center px-20 flex flex-col ">
          <h1 className="text-3xl font-sans font-bold mt-20 mb-10">Pricing</h1>
          <p className="text-xl text-gray-500 mb-6">
            Our Pricing is simple, 1 hour is $6 for every 10 hours you purchase
            you get an additional 10% off your total, up to 60% off your total.
            use our calculator to see how much you'll pay
          </p>
